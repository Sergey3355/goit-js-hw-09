...
function minusTime() {
    ...
    timerX = setInterval(()=>{
        ...
        timer();
        if (intervalId - 1000 < 0) clearInterval(timerX);
    }, 1000);
}
...
(0, _flatpickrDefault.default)(selector, options);

},{"flatpickr":"llQu5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","flatpickr/dist/flatpickr.min.css":"eVN6V","notiflix/build/notiflix-notify-aio":"eXQLZ"}],"llQu5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
